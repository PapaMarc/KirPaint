...
/*! https://cdn.jsdelivr.net/npm/@tsparticles/confetti@3.0.3/tsparticles.confetti.bundle.min.js.LICENSE.txt */
/*! which reads: tsParticles Confetti Preset 3.0.3 by Matteo Bruni */
...
!(function (t, e) {
  ...
  (() => {
    ...
    class Se extends Ce {
      ...
      load(t) {
        (super.load(t),
          t && void 0 !== t.offset && (this.offset = D(t.offset)));
      }
    }
    class ke {
      constructor() {
